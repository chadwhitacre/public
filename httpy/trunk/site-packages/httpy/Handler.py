...
class Handler:
    ...
    def _handle_request_safely(self, request):
        ...
        This is guaranteed to return something to serve.
    ...
    def _geterror(self, request, error):
        ...
        if (request.command == 'HEAD') or (error.code == 304):
            ...
            template = None
            error_template_path = os.path.join(self.__, 'error.pt')
            if os.path.exists(error_template_path):
                template = self.templates.getXMLTemplate(error_template_path)
