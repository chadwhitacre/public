...
$Id: declarations.py 30341 2005-05-12 16:02:42Z poster $
"""
__docformat__ = 'restructuredtext'
import sys
import weakref
from httpy._zope.interface.interface import InterfaceClass, Specification
from ro import mergeOrderings, ro
import exceptions
from types import ClassType
from httpy._zope.interface.advice import addClassAdvisor
...
def implementedByFallback(cls):
    ...
    try:
        ...
        # We don't want to depend directly on httpy._zope.security in
        # httpy._zope.interface, but we'll try to make reasonable
...
class Provides(Declaration):  # Really named ProvidesClass
    ...
    __module__ = 'httpy._zope.interface'
...
# Try to get C base:
try:
    import _httpy._zope_interface_coptimizations
except ImportError:
    pass
else:
    from _httpy._zope_interface_coptimizations import ClassProvidesBase
...
try:
    ...
    from _httpy._zope_interface_coptimizations import implementedBy, providedBy
    from _httpy._zope_interface_coptimizations import getObjectSpecification
    from _httpy._zope_interface_coptimizations import ObjectSpecificationDescriptor
