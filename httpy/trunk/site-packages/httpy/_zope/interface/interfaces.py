...
from httpy._zope.interface.interface import Attribute
...
class ISpecification(Interface):
    ...
    def weakref(callback=None):
        ...
        httpy._zope.interface package does not require httpy._zope.security or
        httpy._zope.proxy, it has to be able to coexist with it.
...
class IInterface(ISpecification, IElement):
    ...
    o You assert that your object implement the interfaces.
      ...
      1. Call httpy._zope.interface.implements in your class definition.

      2. Call httpy._zope.interfaces.directlyProvides on your object.

      3. Call 'httpy._zope.interface.classImplements' to assert that instances
