...
$Id: test_declarations.py 37602 2005-07-30 15:24:26Z jim $
"""
import unittest
from httpy._zope.interface import *
from httpy._zope.testing.doctestunit import DocTestSuite
...
class Test(unittest.TestCase):
    ...
    def test_module(self):
        import httpy._zope.interface.tests.m1
        import httpy._zope.interface.tests.m2
        directlyProvides(httpy._zope.interface.tests.m2,
                         httpy._zope.interface.tests.m1.I1,
                         httpy._zope.interface.tests.m1.I2,
                         )
        self.assertEqual(list(providedBy(httpy._zope.interface.tests.m1)),
                         list(providedBy(httpy._zope.interface.tests.m2)),
                         )
...
def test_getting_spec_for_proxied_builtin_class():
    ...
    We don't want to depend on proxies in this (httpy._zope.interface)
    ...
    We'll create an implements specification:
      ...
      >>> import httpy._zope.interface.declarations
      >>> impl = httpy._zope.interface.declarations.Implements(I1, I2)

    Now, we'll emulate a declaration for a built-in type by putting
    it in BuiltinImplementationSpecifications:

      >>> httpy._zope.interface.declarations.BuiltinImplementationSpecifications[
      ...   cls] = impl
    ...
    Of course, we don't want to leave it there. :)
      ...
      >>> del httpy._zope.interface.declarations.BuiltinImplementationSpecifications[
      ...   cls]
...
def test_declaration_get():
    ...
    We can get definitions from a declaration:
        ...
        >>> import httpy._zope.interface
        >>> class I1(httpy._zope.interface.Interface):
        ...    a11 = httpy._zope.interface.Attribute('a11')
        ...    a12 = httpy._zope.interface.Attribute('a12')
        >>> class I2(httpy._zope.interface.Interface):
        ...    a21 = httpy._zope.interface.Attribute('a21')
        ...    a22 = httpy._zope.interface.Attribute('a22')
        ...    a12 = httpy._zope.interface.Attribute('a212')
        >>> class I11(I1):
        ...    a11 = httpy._zope.interface.Attribute('a111')
...
def test_suite():
    ...
    suite.addTest(DocTestSuite("httpy._zope.interface.declarations"))
