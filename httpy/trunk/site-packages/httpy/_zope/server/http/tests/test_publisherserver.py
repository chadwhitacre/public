...
$Id: test_publisherserver.py 30411 2005-05-19 08:28:32Z hdima $
"""
import unittest
...
from httpy._zope.server.http.publisherhttpserver import PublisherHTTPServer

from httpy._zope.component.testing import PlacelessSetup
import httpy._zope.component

from httpy._zope.i18n.interfaces import IUserPreferredCharsets

from httpy._zope.publisher.http import IHTTPRequest
from httpy._zope.publisher.http import HTTPCharsets
from httpy._zope.publisher.browser import BrowserRequest
from httpy._zope.publisher.base import DefaultPublication
from httpy._zope.publisher.interfaces import Redirect, Retry
from httpy._zope.publisher.http import HTTPRequest
...
class Tests(PlacelessSetup, unittest.TestCase):
    ...
    def setUp(self):
        ...
        httpy._zope.component.provideAdapter(HTTPCharsets, [IHTTPRequest],
