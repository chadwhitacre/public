...
$Id: server.py 29894 2005-04-07 01:14:11Z srichter $
"""
import asyncore
import posixpath
import socket
...
from httpy._zope.security.interfaces import Unauthorized
...
from httpy._zope.server.interfaces.ftp import IFileSystemAccess
from httpy._zope.server.interfaces.ftp import IFTPCommandHandler
from httpy._zope.server.linereceiver.lineserverchannel import LineServerChannel
from httpy._zope.server.serverbase import ServerBase
from httpy._zope.server.dualmodechannel import DualModeChannel, the_trigger
...
class FTPServer(ServerBase):
    ...
    SERVER_IDENT = 'httpy._zope.server.ftp'
