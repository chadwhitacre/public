...
class RequestPath(unicode):
    """Represent a URI path, which has several possible referents.
    """

    __slots__ = ('info', 'translated')

    def __new__(cls, path, info=None, translated=None):
        """Takes a URI path, and possibly some derivatives.
        """
        instance = unicode.__new__(cls, path)
        instance.info = info
