...
class IFramework(Interface):
    ...
    """
    Request = Attribute('Request', 'A callable that takes an IRequest')
    Response = Attribute('Response', 'A callable that returns an IResponse')
...
class IResponseFlag(Interface):
    ...
    Your framework's Response callable must return an object that inherits from
    ResponseFlag in order to work properly with httpy's outbound framework hook.
