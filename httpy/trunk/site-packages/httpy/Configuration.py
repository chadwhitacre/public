...
class Configuration:
    ...
    def _validate(self, context, d):
        ...
        ConfigError is raised. Superfluous keys are removed.
        ...
        if d.has_key('defaults'):
            ...
            errmsg = "[%s] Defaults must be a whitespace-" % context +\
        ...
        if d.has_key('extensions'):
            ...
            errmsg = "[%s] Extensions must be a whitespace-" % context +\
