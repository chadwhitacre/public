...
class Transaction:
    ...
    def __init__(self, config, request):
        """Takes a dictionary of config info and an httpy.Request.
        """
        self.config = config
    ...
    def process(self):
        ...
        response.headers['Content-Type'] = guess_type(request.path)[0] or 'text/plain'
