...
class Server(ServerBase):
    ...
    def __init__(self, config):
        ...
        server, which would probably change the meaning of that parameter. The
        AppCache that we build here is keyed to the applications' filesystem
        roots; the values are application objects.
    ...
    def start(self):
        ...
        try:
            ...
            log(90, 'starting httpy on port %s ...' % port)
            log(99, "%s\n\n" % ("="*76))
