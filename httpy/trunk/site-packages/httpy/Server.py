...
class Server(ServerBase):
    ...
    def _prime_apps(self):
        """Hook into sys.path and preload all apps on the site.

        The AppCache that we build here is keyed to the applications' magic
        directories; the values are application objects.
        ...
        self.apps = AppCache(self.config['mode'])
        for app in self.config['apps']:
            app_fs_root = os.path.join(self.config['root'], app.lstrip('/'))
