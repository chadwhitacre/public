...
from httpy.apps.Static import StaticApp
from httpy.interfaces import IApp, IApplication, IFramework
from httpy.frameworks import PassThrough
...
class Loader:
    ...
    def get_apps(self):
        ...
        is found there, then we fall back to StaticApp.
        ...
        # If we didn't find an app in __ either, use StaticApp.
        # =====================================================
