...
class Server(ServerBase):
    ...
    def __init__(self, config, threads=10):
        ...
        server, which may change the meaning of that parameter. The AppCache
        that we build here is keyed to the applications' filesystem roots; the
        values are application objects.
