...
class AppConfig:
    ...
    def __init__(self, site_root, app_uri_root):
        ...
        fs_root = os.path.join(site_root, *_parts)
        if not os.path.isdir(fs_root):
            raise ServerConfigError(msg % fs_root)
    ...
    def __repr__(self):
        ...
        return "<httpy app from %s>" % self.__


    def _load_module(self, __):
        ...
        if __ is None:
            ...
            try:
                ...
                print >> sys.stderr, ("There was an error importing an app " +
                                      "from %s:" % __)
                raise
