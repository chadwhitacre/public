...
class Config(dict):
    ...
    ConfigError is raised. These dictionaries are combined in the order given
    above, such that environment variables override defaults, etc. Finally, the
    combined dictionary is transfered to self. A Config instance has the
    following values:
        ...
        verbosity
                an integer between 0 and 100, inclusive, indicating how much
                information to log
