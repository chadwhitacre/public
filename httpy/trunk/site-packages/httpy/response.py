...
class Response(StandardError):
    ...
    def __init__(self, code=200, body='', headers=None):
        ...
        headers, than a header without a body. Note that, per the spec,
        Content-Type defaults to application/unknown, so you must set this
        content type even for text/html content:
        ...
        if not isinstance(code, int):
            ...
            raise TypeError("'body' must be a string, an iterator, or a Path")
