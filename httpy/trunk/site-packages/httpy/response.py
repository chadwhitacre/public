...
class Response(StandardError):
    ...
    Responders may raise or return an instance of this class, and Task will
    catch, validate, and flatten it before writing it to the wire.
    ...
    def __str__(self):
        return "%d %s" % (self.code, StatusCodes.get(self.code, ('???',))[0])
