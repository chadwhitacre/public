...
class Task:
    ...
    def process(self):
        ...
        try:
            ...
            app_root = response.app_root
            __ = None
            del response.app_root
            if (response.code != 500) or (app_root != root):
                raise
        ...
        # don't get confused importing from each other.
        ...
        # Get and instantiate a Transaction.
        # ==================================
        ...
        if not __:
            ...
            if not dev_mode:
                Transaction = self.server.transactions.get(__)
            else:
                Transaction = get_transaction(__)
    ...
    def map_path(self, root, apps, path):
        ...
        # ================================================================
        # If there is no magic directory, then we raise an error. The frame
        # above us will decide if we should implictly revert to DefaultApp.
