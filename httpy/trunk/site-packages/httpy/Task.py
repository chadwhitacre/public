...
class Task:
    ...
    The httpy._zope.server machinery instantiates this once for each HTTP request, and
    ...
    def __init__(self, channel, request):
        ...
        try:
            ...
            self.dev_mode = self.channel.server.config.mode == 'development'

            self.request = Request(request)
            self.config = self.configure(self.channel.server.config)
    ...
    def process(self):
        ...
        transaction = self.app.Transaction(self.config)
    ...
    def check_mtimes(self):
        ...
        This gets called in development mode after each request has been served.
