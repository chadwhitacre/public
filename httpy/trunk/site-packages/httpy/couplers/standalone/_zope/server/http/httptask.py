...
$Id: httptask.py 28486 2004-11-22 10:11:12Z jim $
"""
import socket
import time

from httpy._zope.server.http.http_date import build_http_date
from httpy._zope.publisher.interfaces.http import IHeaderOutput
...
class HTTPTask(object):
    ...
    def service(self):
        """See httpy._zope.server.interfaces.ITask"""
        try:
            try:
                self.start()
    ...
    def setResponseStatus(self, status, reason):
        """See httpy._zope.publisher.interfaces.http.IHeaderOutput"""
        self.status = status
        self.reason = reason
