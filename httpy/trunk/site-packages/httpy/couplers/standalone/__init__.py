...
def Coupler(responder=None, configurator=None, argv=None):
    """Starts an HTTP server.

    Takes an IResponder instance, an IConfig class, and an argv. This was
    originally inspired by Guido's main() function:
    ...
    responder = responder or responders.Multiple()
