...
from encodings import utf_8 # explicit import, to be friendly to freeze.py
...
class Deliver:
    ...
    def respond(self, request):
        ...
        if response is None:
            print >> sys.stderr, "Responder %s returned None" % str(self.responder)
            return Response(500)
