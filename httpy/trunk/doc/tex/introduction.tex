...
\module{httpy}'s specific job is to get HTTP requests off the wire into your
...
HTTP Request and Response messages, \module{httpy} is organized around just two
