...
describe \module{httpy} positively, by the bells and whistles it does have, and
in relief, pointing out what it is explicitly not. Lastly, I attempt to locate
\module{httpy} on the Python web programming map, with a view towards defending
its existence.
...
combination of HTTP and Python. With \module{httpy}, I have tried to knit these
