...
class SpecificationBasePy(object):
    ...
    def isOrExtends(self, interface):
        ...
        Examples::
          ...
          >>> from httpy._zope.interface.declarations import Declaration
...
try:
    from _httpy._zope_interface_coptimizations import SpecificationBase
except ImportError:
    pass
        ...
        def __call__(self, obj, alternate=marker):
            """Adapt an object to the interface
               ...
               If an object cannot be adapted, then a TypeError is raised::
                 ...
                 >>> class I(httpy._zope.interface.Interface):
                 ...     pass
                 ...
                 TypeError: ('Could not adapt', 0, """ \
                      """<InterfaceClass httpy._zope.interface.interface.I>)
               ...
               returned::
                 ...
                 >>> class C(object):
                 ...     httpy._zope.interface.implements(I)
               ...
               Adapter hooks (see __adapt__) will also be used, if present:
                 ...
                 >>> from httpy._zope.interface.interface import adapter_hooks
...
Interface = InterfaceClass("Interface", __module__ = 'httpy._zope.interface')
...
def _wire():
    from httpy._zope.interface.declarations import classImplements

    from httpy._zope.interface.interfaces import IAttribute
    classImplements(Attribute, IAttribute)

    from httpy._zope.interface.interfaces import IMethod
    classImplements(Method, IMethod)

    from httpy._zope.interface.interfaces import IInterface
    classImplements(InterfaceClass, IInterface)

# We import this here to deal with module dependencies.
from httpy._zope.interface.declarations import providedBy, implementedBy
from httpy._zope.interface.exceptions import InvalidInterface
