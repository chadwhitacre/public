...
from httpy._zope.interface.tests.unitfixtures import *  # hehehe
from httpy._zope.interface.exceptions import BrokenImplementation, Invalid
from httpy._zope.interface import implementedBy, providedBy
from httpy._zope.interface import Interface, directlyProvides, Attribute
from httpy._zope import interface
...
class InterfaceTests(unittest.TestCase):
    ...
    def testIssue228(self):
        # Test for http://collector.httpy._zope.org/Zope3-dev/228
        class I(Interface):
            "xxx"
        class Bad:
            __providedBy__ = None
...
def test_suite():
    from httpy._zope.testing import doctest
    suite = unittest.makeSuite(InterfaceTests)
    suite.addTest(doctest.DocTestSuite("httpy._zope.interface.interface"))
    if sys.version_info >= (2, 4):
