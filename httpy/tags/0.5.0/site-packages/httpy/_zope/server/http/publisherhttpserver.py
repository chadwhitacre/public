...
$Id: publisherhttpserver.py 37557 2005-07-29 18:19:31Z benji_york $
"""
from httpy._zope.server.http.httpserver import HTTPServer
from httpy._zope.publisher.publish import publish
import httpy._zope.security.management
...
class PublisherHTTPServer(HTTPServer):
    ...
    def __init__(self, request_factory, sub_protocol=None, *args, **kw):
        ...
        # when the host name is omitted from the server address (in httpy._zope.conf).
        # The address comes in as 'localhost' from ZServerConfig by way of some
...
class PMDBHTTPServer(PublisherHTTPServer):
    ...
    def executeRequest(self, task):
        ...
        try:
            ...
            httpy._zope.security.management.restoreInteraction()
            try:
                pdb.post_mortem(sys.exc_info()[2])
                raise
            finally:
                httpy._zope.security.management.endInteraction()
