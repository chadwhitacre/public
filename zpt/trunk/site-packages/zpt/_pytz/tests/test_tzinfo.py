...
import zpt._pytz
from zpt._pytz import reference
...
UTC = zpt._pytz.timezone('UTC')
GMT = zpt._pytz.timezone('GMT')

class BasicTest(unittest.TestCase):

    def testVersion(self):
        # Ensuring the correct version of zpt._pytz has been loaded
        self.failUnlessEqual('2005m', zpt._pytz.__version__,
                'Incorrect zpt._pytz version loaded. Import path is stuffed '
...
class PicklingTest(unittest.TestCase):
    ...
    def testDst(self):
        tz = zpt._pytz.timezone('Europe/Amsterdam')
    ...
    def testRoundtrip(self):
        dt = datetime(2004, 2, 1, 0, 0, 0)
        for zone in zpt._pytz.all_timezones:
            tz = zpt._pytz.timezone(zone)
    ...
    def testDatabaseFixes(self):
        ...
        # to repair this case
        tz = zpt._pytz.timezone('Australia/Melbourne')
        p = pickle.dumps(tz)
        tzname = tz._tzname
...
class USEasternDSTStartTestCase(unittest.TestCase):
    tzinfo = zpt._pytz.timezone('US/Eastern')
...
class WarsawWMTEndTestCase(USEasternDSTStartTestCase):
    ...
    tzinfo = zpt._pytz.timezone('Europe/Warsaw')
...
class VilniusWMTEndTestCase(USEasternDSTStartTestCase):
    ...
    tzinfo = zpt._pytz.timezone('Europe/Vilnius')
...
class LocalTestCase(unittest.TestCase):
    def testLocalize(self):
        loc_tz = zpt._pytz.timezone('Europe/Amsterdam')
        ...
        # Switch to US
        loc_tz = zpt._pytz.timezone('US/Eastern')
        ...
        self.failUnlessRaises(zpt._pytz.AmbiguousTimeError,
    ...
    def testNormalize(self):
        tz = zpt._pytz.timezone('US/Eastern')
...
def test_suite():
    ...
    suite.addTest(doctest.DocTestSuite('zpt._pytz'))
    suite.addTest(doctest.DocTestSuite('zpt._pytz.tzinfo'))
    import test_tzinfo
