...
$Id: __init__.py 30925 2005-06-25 16:57:27Z philikon $
"""
import sys
import zpt._zope.interface
from types import ClassType
from zpt._zope.interface import moduleProvides, Interface
from zpt._zope.interface import providedBy, implementedBy
from zpt._zope.component.interfaces import IComponentArchitecture
from zpt._zope.component.interfaces import IComponentRegistrationConvenience
from zpt._zope.component.interfaces import IDefaultViewName
from zpt._zope.component.interfaces import IFactory
...
from zpt._zope.component.bbb import exceptions
sys.modules['zpt._zope.component.exceptions'] = exceptions
from zpt._zope.component.bbb import service
sys.modules['zpt._zope.component.service'] = service
from zpt._zope.component.bbb import adapter
sys.modules['zpt._zope.component.adapter'] = adapter
from zpt._zope.component.bbb import utility
sys.modules['zpt._zope.component.utility'] = utility
from zpt._zope.component.bbb import servicenames
sys.modules['zpt._zope.component.servicenames'] = servicenames
from zpt._zope.component.bbb import contextdependent
sys.modules['zpt._zope.component.contextdependent'] = contextdependent

from zpt._zope.component.bbb import tests as bbb_tests
bbb_tests.__warn__ = False
from zpt._zope.component.bbb.tests import placelesssetup
sys.modules['zpt._zope.component.tests.placelesssetup'] = placelesssetup
from zpt._zope.component.bbb.tests import request
sys.modules['zpt._zope.component.tests.request'] = request
from zpt._zope.component.bbb.tests import components
sys.modules['zpt._zope.component.tests.components'] = components
...
from zpt._zope.component.bbb import getGlobalServices, getGlobalService
from zpt._zope.component.bbb import getServices, getService
from zpt._zope.component.bbb import getServiceDefinitions
from zpt._zope.component.bbb import getView, queryView
from zpt._zope.component.bbb import getMultiView, queryMultiView
from zpt._zope.component.bbb import getViewProviding, queryViewProviding
from zpt._zope.component.bbb import getDefaultViewName, queryDefaultViewName
from zpt._zope.component.bbb import getResource, queryResource
##############################################################################


# Try to be hookable. Do so in a try/except to avoid a hard dependency.
try:
    from zpt._zope.hookable import hookable
except ImportError:
    def hookable(ob):
        return ob
...
# registry of the `zpt._zope.inteface` package. This way we will be able to call
...
import zpt._zope.interface.interface
zpt._zope.interface.interface.adapter_hooks.append(adapter_hook)
#############################################################################
