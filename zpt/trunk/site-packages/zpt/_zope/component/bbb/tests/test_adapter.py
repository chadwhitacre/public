...
from zpt._zope.component.adapter import GlobalAdapterService
...
class GlobalAdapterServiceTests(unittest.TestCase):
    ...
    def BBB_test_pickling(self):
        from zpt._zope.component.bbb.tests.test_service import testServiceManager
        from zpt._zope.component.interfaces import IAdapterService
...
def test_suite():
    ...
    suite.addTest(DocTestSuite('zpt._zope.component.adapter'))
    return suite
