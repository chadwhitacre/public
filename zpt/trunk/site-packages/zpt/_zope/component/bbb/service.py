...
from zpt._zope.component.bbb.interfaces import IServiceService
from zpt._zope.interface import implements, Interface, directlyProvides
...
class GlobalServiceManager(object):
    ...
    def getService(self, name):
        ...
        if name == 'Adapters':
            from zpt._zope.component.bbb.adapter import GlobalAdapterService
            return GlobalAdapterService(self.sm)

        if name == 'Utilities':
            from zpt._zope.component.bbb.utility import GlobalUtilityService
