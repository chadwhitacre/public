...
$Id: utility.py 29143 2005-02-14 22:43:16Z srichter $
"""
from zpt._zope.component.exceptions import Invalid, ComponentLookupError
from zpt._zope.component.interfaces import IUtilityService, IRegistry
from zpt._zope.component.service import GlobalService, IService, IServiceDefinition
from zpt._zope.component.site import UtilityRegistration
...
class GlobalUtilityService(UtilityService, GlobalService):
    ...
    zpt._zope.interface.implementsOnly(IGlobalUtilityService)
