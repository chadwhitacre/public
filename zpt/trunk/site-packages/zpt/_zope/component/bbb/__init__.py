...
from zpt._zope.interface import Interface, providedBy
from zpt._zope.component.bbb.interfaces import IServiceService, IDefaultViewName
from zpt._zope.component.bbb.service import GlobalServiceManager
...
def warningLevel():
    """Returns the number of the first stack frame outside of zpt._zope.component"""
    try:
        level = 2
        while sys._getframe(level).f_globals['__name__']=='zpt._zope.component.bbb':
            level += 1
        return level
    except ValueError:
        return 2
...
def getGlobalServices():
    ...
    from zpt._zope.component import getGlobalSiteManager
    return GlobalServiceManager('servicemanager', 'zpt._zope.component.service',
...
def getServices(context=None):
    ...
    if context is None:
        ...
        try:
            ...
            from zpt._zope.component.bbb.exceptions import ComponentLookupError
...
def queryResource(name, request, default=None, providing=Interface,
    ...
    if __warn__:
        warnings.warn(
            ...
            DeprecationWarning, warningLevel())
    from zpt._zope.component import queryAdapter
