...
from zpt._zope.component.interfaces import IAdapterService, IRegistry
from zpt._zope.component.bbb.service import GlobalService
from zpt._zope.component.site import AdapterRegistration, SubscriptionRegistration
from zpt._zope.interface import implements, providedBy, Interface, implementedBy
...
class GlobalAdapterService(AdapterService, GlobalService):
    ...
    def register(self, required, provided, name, factory, info=''):
        ...
        <class 'zpt._zope.component.bbb.adapter.O3'>
