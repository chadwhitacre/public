...
from zpt._zope.interface import Interface, implements
from zpt._zope.interface.verify import verifyObject
from zpt._zope.testing import doctest

import zpt._zope.component
from zpt._zope.component.interfaces import ComponentLookupError
from zpt._zope.component.interfaces import IComponentArchitecture
from zpt._zope.component.interfaces import ISiteManager
from zpt._zope.component.testing import setUp, tearDown
...
def test_getGlobalSiteManager():
    """One of the most important functions is to get the global site manager.
      ...
      >>> from zpt._zope.component.site import IGlobalSiteManager, globalSiteManager

    Get the global site manager via the CA API function:

      >>> gsm = zpt._zope.component.getGlobalSiteManager()
    ...
    our component registry will always be reset. 
      ...
      >>> zpt._zope.component.getGlobalSiteManager() is gsm
      True
    """
...
def test_getSiteManager():
    ...
    is an `ISiteManager`.
      ...
      >>> ISiteManager.providedBy(zpt._zope.component.getSiteManager())
      True

    Calling `getSiteManager()` with no args is equivalent to calling it with a
    context of `None`.

      >>> zpt._zope.component.getSiteManager() is zpt._zope.component.getSiteManager(None)
      True
    ...
    site manager.
      ...
      >>> zpt._zope.component.getSiteManager(context) is sitemanager
      True

    Using a context that is not adaptable to `ISiteManager` should fail.

      >>> zpt._zope.component.getSiteManager(ob) #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError: ('Could not adapt', <instance Ob>,
      <InterfaceClass zpt._zope.component.interfaces.ISiteManager>)
    """
...
def testAdapterInContext(self):
    ...
    `getAdapterInContext()` should simply return the object.
      ...
      >>> zpt._zope.component.getAdapterInContext(ob, I1, context)
      <Component implementing 'I1'>
      >>> zpt._zope.component.queryAdapterInContext(ob, I1, context)
      <Component implementing 'I1'>

    If an object conforms to the interface you want to adapt to,
    `getAdapterInContext()` should simply return the conformed object.

      >>> zpt._zope.component.getAdapterInContext(ob, I2, context)
      42
      >>> zpt._zope.component.queryAdapterInContext(ob, I2, context)
      42
    ...
    provide no default, raise ComponentLookupError...
      ...
      >>> zpt._zope.component.getAdapterInContext(ob, I4, context) \\
      ... #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError: (<Component implementing 'I1'>,
                             <InterfaceClass zpt._zope.component.tests.I4>)

    ...otherwise, you get the default:

      >>> zpt._zope.component.queryAdapterInContext(ob, I4, context, 44)
      44

    If you ask for an adapter for which something's registered you get the
    registered adapter

      >>> zpt._zope.component.getAdapterInContext(ob, I3, context)
      43
      >>> zpt._zope.component.queryAdapterInContext(ob, I3, context)
      43
    """
...
def testAdapter():
    ...
    provide no default, raise `ComponentLookupError`...
      ...
      >>> zpt._zope.component.getAdapter(ob, I2, '') #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError: (<instance Ob>,
                             <InterfaceClass zpt._zope.component.tests.I2>,
                             '')

    ...otherwise, you get the default

      >>> zpt._zope.component.queryAdapter(ob, I2, '', '<default>')
      '<default>'

    Now get the global site manager and register an adapter from `I1` to `I2`
    without a name:
      
      >>> zpt._zope.component.getGlobalSiteManager().provideAdapter(
      ...     (I1,), I2, '', Comp)

    You can now simply access the adapter using the `getAdapter()` API
    function:

      >>> adapter = zpt._zope.component.getAdapter(ob, I2, '')
...
def testInterfaceCall():
    ...
    `zpt._zope.interface` adapter hook registry, so that we can call interfaces to
    do adaptation.
    ...
    If no adapter is found, a `TypeError is raised...
      ...
      TypeError: ('Could not adapt', <instance Ob2>,
                  <InterfaceClass zpt._zope.component.tests.I1>)
...
def testNamedAdapter():
    ...
    and you provide no default, raise `ComponentLookupError`...
      ...
      >>> zpt._zope.component.getAdapter(ob, I2, 'bar') \\
      ... #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError: 
      (<instance Ob>, <InterfaceClass zpt._zope.component.tests.I2>, 'bar')

    ...otherwise, you get the default

      >>> zpt._zope.component.queryAdapter(ob, I2, 'bar', '<default>')
      '<default>'
    ...
    so that the lookup succeeds:
      ...
      >>> adapter = zpt._zope.component.getAdapter(ob, I2, 'bar')
      >>> adapter.__class__ is Comp
      True
      >>> adapter.context is ob
      True
...
def testMultiAdapter():
    ...
    `ComponentLookupError`...
      ...
      >>> zpt._zope.component.getMultiAdapter((ob, ob2), I3) \\
      ... #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError:
      ((<instance Ob>, <instance Ob2>),
       <InterfaceClass zpt._zope.component.tests.I3>,
       u'')

    ...otherwise, you get the default

      >>> zpt._zope.component.queryMultiAdapter((ob, ob2), I3, default='<default>')
      '<default>'
    ...
    can get the adapter:
      ...
      >>> adapter = zpt._zope.component.getMultiAdapter((ob, ob2), I3)
...
def testGetAdapters():
    ...
    `I2`:
      ...
      >>> adapters = zpt._zope.component.getAdapters((ob,), I2)
      >>> adapters.sort()
...
def testUtility():
    ...
    you do not specify a default, you get a `ComponentLookupError`...
      ...
      >>> zpt._zope.component.getUtility(I1) #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError: \
      (<InterfaceClass zpt._zope.component.tests.I1>, '')
    ...
    ...otherwise, you get the default
      ...
      >>> zpt._zope.component.queryUtility(I1, default='<default>')
      '<default>'
      >>> zpt._zope.component.queryUtility(I2, default='<default>')
      '<default>'

    Now we declare `ob` to be the utility providing `I1`

      >>> zpt._zope.component.getGlobalSiteManager().provideUtility(I1, ob)

    so that the component is now available:
    
      >>> zpt._zope.component.getUtility(I1) is ob
      True
    """
...
def testNamedUtility():
    ...
    does not mean that they are available when you specify a name:
      ...
      >>> zpt._zope.component.getUtility(I1, name='foo') \\
      ... #doctest: +NORMALIZE_WHITESPACE
      Traceback (most recent call last):
      ...
      ComponentLookupError:
      (<InterfaceClass zpt._zope.component.tests.I1>, 'foo')


    ...otherwise, you get the default

      >>> zpt._zope.component.queryUtility(I1, name='foo', default='<default>')
      '<default>'

    Registering the utility under the correct name 

      >>> zpt._zope.component.getGlobalSiteManager().provideUtility(
      ...     I1, ob, name='foo')

    really helps:

      >>> zpt._zope.component.getUtility(I1, 'foo') is ob
      True
    """
...
def test_getAllUtilitiesRegisteredFor():
    ...
    We can now get all the utilities that provide interface `I1`:
      ...
      >>> uts = list(zpt._zope.component.getAllUtilitiesRegisteredFor(I1))
...
def test_ability_to_pickle_globalsitemanager():
    ...
    and its two global adapter registries.
      ...
      >>> from zpt._zope.component import site
      >>> import cPickle
...
def test_suite():
    return unittest.TestSuite((
        ...
        doctest.DocTestSuite('zpt._zope.component.site'),
...
from zpt._zope.component.bbb.tests import placelesssetup
