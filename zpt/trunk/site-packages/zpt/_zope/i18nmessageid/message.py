...
$Id: message.py 37557 2005-07-29 18:19:31Z benji_york $
"""
...
class Message(unicode):
    ...
    >>> from zpt._zope.i18nmessageid.message import pyMessage as Message
    ...
    >>> import zpt._zope.i18nmessageid.message
    >>> oldMessage = zpt._zope.i18nmessageid.message.Message
    >>> zpt._zope.i18nmessageid.message.Message = Message
    ...
    True
    >>> from zpt._zope.i18nmessageid.message import pyMessage
    >>> pickle_bot.__reduce__()[0] is pyMessage
    True
    >>> del pickle_bot
    
    At second check if cMessage is able to load the state of a pyMessage
    >>> from _zpt._zope_i18nmessageid_message import Message
    >>> zpt._zope.i18nmessageid.message.Message = Message
    >>> c_bot = loads(pystate)
    ...
    >>> c_bot._readonly
    Traceback (most recent call last):
    AttributeError: 'zpt._zope.i18nmessageid.message.Message' object has no attribute '_readonly'
    >>> from _zpt._zope_i18nmessageid_message import Message as cMessage
    ...
    >>> zpt._zope.i18nmessageid.message.Message = oldMessage
    """
