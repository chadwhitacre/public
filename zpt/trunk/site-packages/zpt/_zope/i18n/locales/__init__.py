...
$Id: __init__.py 30750 2005-06-10 23:57:01Z philikon $
"""
import os
from datetime import datetime, date
from time import strptime

from zpt._zope.interface import implements
from zpt._zope.i18n.interfaces.locales import ILocale
from zpt._zope.i18n.interfaces.locales import ILocaleDisplayNames, ILocaleDates
from zpt._zope.i18n.interfaces.locales import ILocaleVersion, ILocaleIdentity
from zpt._zope.i18n.interfaces.locales import ILocaleTimeZone, ILocaleCalendar
from zpt._zope.i18n.interfaces.locales import ILocaleCurrency, ILocaleNumbers
from zpt._zope.i18n.interfaces.locales import ILocaleFormat, ILocaleFormatLength
from zpt._zope.i18n.interfaces.locales import ILocaleOrientation
from zpt._zope.i18n.format import NumberFormat, DateTimeFormat
from zpt._zope.i18n.locales.inheritance import \
     AttributeInheritance, InheritingDictionary, NoParentException
from zpt._zope.i18n.locales.provider import LocaleProvider, LoadLocaleError

# Setup the locale directory
from zpt._zope import i18n
...
class LocaleVersion(object):
    ...
    def __cmp__(self, other):
        "See zpt._zope.i18n.interfaces.ILocaleVersion"
...
class LocaleDisplayNames(AttributeInheritance):
    ...
    Examples::
      ...
      >>> from zpt._zope.i18n.locales.tests.test_docstrings import \\
...
class LocaleCalendar(AttributeInheritance):
    ...
    def getMonthNames(self):
        """See zpt._zope.i18n.interfaces.ILocaleCalendar"""
...
class LocaleDates(AttributeInheritance):
    ...
    Examples::
      ...
      >>> from zpt._zope.i18n.tests.test_formats import LocaleCalendarStub as Stub
    ...
    def getFormatter(self, category, length=None, name=None,
        ...
        """See zpt._zope.i18n.interfaces.locales.ILocaleDates"""
...
`    Examples::
    ...
    def getFormatter(self, category, length=None, name=None):
        """See zpt._zope.i18n.interfaces.locales.ILocaleNumbers"""
...
class Locale(AttributeInheritance):
    ...
    def getInheritedSelf(self):
        """See zpt._zope.i18n.interfaces.locales.ILocaleInheritance
