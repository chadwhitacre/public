...
$Id: test_translationdomain.py 29403 2005-03-06 15:12:39Z philikon $
"""
import unittest, os
from zpt._zope.i18n.translationdomain import TranslationDomain
from zpt._zope.i18n.gettextmessagecatalog import GettextMessageCatalog
from zpt._zope.i18n.tests.test_itranslationdomain import \
     TestITranslationDomain, Environment
from zpt._zope.i18n import MessageIDFactory
from zpt._zope.i18n.interfaces import ITranslationDomain
import zpt._zope.component

def testdir():
    from zpt._zope.i18n import tests
...
class TestGlobalTranslationDomain(unittest.TestCase, TestITranslationDomain):
    ...
    def testMessageIDTranslateForDifferentDomain(self):
        ...
        zpt._zope.component.provideUtility(domain, ITranslationDomain, 'other')
