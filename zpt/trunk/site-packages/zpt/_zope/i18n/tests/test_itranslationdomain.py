...
$Id: test_itranslationdomain.py 29403 2005-03-06 15:12:39Z philikon $
"""
import unittest
...
from zpt._zope.i18n.negotiator import negotiator
from zpt._zope.i18n.interfaces import INegotiator, IUserPreferredLanguages
...
class TestITranslationDomain(PlacelessSetup):
    ...
    def setUp(self):
        ...
        zpt._zope.component.provideUtility(negotiator, INegotiator)        
