...
$Id: test_formats.py 38349 2005-09-07 18:27:36Z poster $
"""
import os
import datetime
import zpt._pytz
...
from zpt._zope.i18n.interfaces import IDateTimeFormat
from zpt._zope.i18n.format import DateTimeFormat
from zpt._zope.i18n.format import parseDateTimePattern, buildDateTimeParseInfo
from zpt._zope.i18n.format import DateTimePatternParseError, DateTimeParseError

from zpt._zope.i18n.interfaces import INumberFormat
from zpt._zope.i18n.format import NumberFormat
from zpt._zope.i18n.format import parseNumberPattern
...
class TestDateTimeFormat(TestCase):
    ...
    def testParseRealDateTime(self):
        ...
        self.assertEqual(self.format.parse(
            ...
            datetime.datetime(2003, 01, 02, 21, 48, 01,
                              tzinfo=zpt._pytz.timezone('Europe/Berlin')))
    ...
    def testParseTimeZoneNames(self):
        ...
        # timezones are handled happily using the zpt._pytz timezone database
    ...
    def testFormatRealDateTime(self):
        tz = zpt._pytz.timezone('Europe/Berlin')
