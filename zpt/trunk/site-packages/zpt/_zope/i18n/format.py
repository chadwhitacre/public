...
$Id: format.py 38349 2005-09-07 18:27:36Z poster $
"""
import re
import math
import datetime
import zpt._pytz
import zpt._pytz.reference

from zpt._zope.i18n.interfaces import IDateTimeFormat, INumberFormat
...
class DateTimeFormat(object):
    ...
    def setPattern(self, pattern):
        "See zpt._zope.i18n.interfaces.IFormat"
        self._pattern = pattern
        self._bin_pattern = parseDateTimePattern(self._pattern,
                                                 self._DATETIMECHARS)
    ...
    def parse(self, text, pattern=None, asObject=True):
        ...
        # Handle timezones
        tzinfo = None
        zpt._pytz_tzinfo = False # If True, we should use zpt._pytz specific syntax
        ...
        if ordered[3:] != [None, None, None, None] and tz_entry:
            ...
            if length == 1:
                ...
                # Note that StaticTzInfo is not part of the exposed zpt._pytz API.
                tzinfo = zpt._pytz.tzinfo.StaticTzInfo()
                tzinfo._utcoffset = delta
                zpt._pytz_tzinfo = True
            elif length == 2:
                ...
                try:
                    tzinfo = zpt._pytz.timezone(value)
                    zpt._pytz_tzinfo = True
                except KeyError:
        ...
        # If we have a zpt._pytz tzinfo, we need to invoke localize() as per
        # the zpt._pytz documentation on creating local times.
...
def buildDateTimeInfo(dt, calendar, pattern):
    ...
    tzinfo = dt.tzinfo or zpt._pytz.utc
