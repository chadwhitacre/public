...
$Id: interface.py 29899 2005-04-07 17:44:44Z jim $
"""
...
from ro import ro
from zpt._zope.interface.exceptions import Invalid
...
class SpecificationBasePy(object):
    ...
    def isOrExtends(self, interface):
        ...
        Examples::
          ...
          >>> from zpt._zope.interface.declarations import Declaration
...
try:
    from _zpt._zope_interface_coptimizations import SpecificationBase
except ImportError:
    pass
        ...
        def __call__(self, obj, alternate=marker):
            """Adapt an object to the interface
               ...
               If an object cannot be adapted, then a TypeError is raised::
                 ...
                 >>> class I(zpt._zope.interface.Interface):
                 ...     pass
                 ...
                 TypeError: ('Could not adapt', 0, """ \
                      """<InterfaceClass zpt._zope.interface.interface.I>)
               ...
               returned::
                 ...
                 >>> class C(object):
                 ...     zpt._zope.interface.implements(I)
               ...
               Adapter hooks (see __adapt__) will also be used, if present:
                 ...
                 >>> from zpt._zope.interface.interface import adapter_hooks
...
Interface = InterfaceClass("Interface", __module__ = 'zpt._zope.interface')
...
def _wire():
    from zpt._zope.interface.declarations import classImplements

    from zpt._zope.interface.interfaces import IAttribute
    classImplements(Attribute, IAttribute)

    from zpt._zope.interface.interfaces import IMethod
    classImplements(Method, IMethod)

    from zpt._zope.interface.interfaces import IInterface
    classImplements(InterfaceClass, IInterface)

# We import this here to deal with module dependencies.
from zpt._zope.interface.declarations import providedBy, implementedBy
from zpt._zope.interface.exceptions import InvalidInterface
from zpt._zope.interface.exceptions import BrokenImplementation
