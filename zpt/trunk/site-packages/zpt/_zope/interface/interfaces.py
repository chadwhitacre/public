...
from zpt._zope.interface.interface import Attribute
...
class ISpecification(Interface):
    ...
    def weakref(callback=None):
        ...
        zpt._zope.interface package does not require zpt._zope.security or
        zpt._zope.proxy, it has to be able to coexist with it.
...
class IInterface(ISpecification, IElement):
    ...
    o You assert that your object implement the interfaces.
      ...
      1. Call zpt._zope.interface.implements in your class definition.

      2. Call zpt._zope.interfaces.directlyProvides on your object.

      3. Call 'zpt._zope.interface.classImplements' to assert that instances
         of a class implement an interface.

         For example::

           from zpt._zope.interface import classImplements
