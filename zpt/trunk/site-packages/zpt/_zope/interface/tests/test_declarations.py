...
"""
import unittest
from zpt._zope.interface import *
from zpt._zope.testing.doctestunit import DocTestSuite
...
class Test(unittest.TestCase):
    ...
    def test_module(self):
        import zpt._zope.interface.tests.m1
        import zpt._zope.interface.tests.m2
        directlyProvides(zpt._zope.interface.tests.m2,
                         zpt._zope.interface.tests.m1.I1,
                         zpt._zope.interface.tests.m1.I2,
                         )
        self.assertEqual(list(providedBy(zpt._zope.interface.tests.m1)),
                         list(providedBy(zpt._zope.interface.tests.m2)),
                         )
...
def test_getting_spec_for_proxied_builtin_class():
    ...
    We don't want to depend on proxies in this (zpt._zope.interface)
    ...
    We'll create an implements specification:
      ...
      >>> import zpt._zope.interface.declarations
      >>> impl = zpt._zope.interface.declarations.Implements(I1, I2)

    Now, we'll emulate a declaration for a built-in type by putting
    it in BuiltinImplementationSpecifications:

      >>> zpt._zope.interface.declarations.BuiltinImplementationSpecifications[
      ...   cls] = impl
    ...
    Of course, we don't want to leave it there. :)
      ...
      >>> del zpt._zope.interface.declarations.BuiltinImplementationSpecifications[
      ...   cls]
...
def test_declaration_get():
    ...
    We can get definitions from a declaration:
        ...
        >>> class I1(zpt._zope.interface.Interface):
        ...    a11 = zpt._zope.interface.Attribute('a11')
        ...    a12 = zpt._zope.interface.Attribute('a12')
        >>> class I2(zpt._zope.interface.Interface):
        ...    a21 = zpt._zope.interface.Attribute('a21')
        ...    a22 = zpt._zope.interface.Attribute('a22')
        ...    a12 = zpt._zope.interface.Attribute('a212')
        >>> class I11(I1):
        ...    a11 = zpt._zope.interface.Attribute('a111')
...
def test_suite():
    ...
    suite.addTest(DocTestSuite("zpt._zope.interface.declarations"))
