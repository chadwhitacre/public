...
from zpt._zope.interface.tests.unitfixtures import *  # hehehe
from zpt._zope.interface.exceptions import BrokenImplementation, Invalid
from zpt._zope.interface import implementedBy, providedBy
from zpt._zope.interface import Interface, directlyProvides, Attribute
from zpt._zope import interface
...
class InterfaceTests(unittest.TestCase):
    ...
    def testIssue228(self):
        # Test for http://collector.zpt._zope.org/Zope3-dev/228
        class I(Interface):
            "xxx"
        class Bad:
            __providedBy__ = None
...
def test_suite():
    ...
    suite.addTest(doctest.DocTestSuite("zpt._zope.interface.interface"))
    if sys.version_info >= (2, 4):
