...
$Id: tales.py 30451 2005-05-20 04:54:15Z fdrake $
"""
import re
...
try:
    from zpt._zope import tal
except ImportError:
    tal = None

if tal:
    from zpt._zope.tal.interfaces import ITALExpressionEngine
    from zpt._zope.tal.interfaces import ITALExpressionCompiler
    from zpt._zope.tal.interfaces import ITALExpressionErrorInfo
    from zpt._zope.tales.interfaces import ITALESIterator
...
class TALESTracebackSupplement(object):
    """Implementation of zpt._zope.exceptions.ITracebackSupplement"""
