...
$Id: test_expressions.py 30451 2005-05-20 04:54:15Z fdrake $
"""
import unittest

from zpt._zope.tales.engine import Engine
from zpt._zope.tales.interfaces import ITALESFunctionNamespace
...
class ExpressionTests(ExpressionTestBase):        
    ...
    def testBadInitalDynamic(self):
        from zpt._zope.tales.tales import CompilerError
        try:
