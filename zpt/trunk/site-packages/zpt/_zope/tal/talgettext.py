...
$Id: talgettext.py 30413 2005-05-19 10:30:35Z hdima $
"""
import sys
import time
import getopt
...
from zpt._zope.tal.talinterpreter import TALInterpreter, normalize
from zpt._zope.tal.dummyengine import DummyEngine
from zpt._zope.tal.interfaces import ITALExpressionEngine
from zpt._zope.tal.taldefs import TALExpressionError
from zpt._zope.i18nmessageid import MessageID
...
class UpdatePOEngine(POEngine):
    ...
    def _loadFile(self):
        ...
        # 25-Mar-2003 Nathan R. Yergler (nathan@zpt._zope.org)
        # 14-Apr-2003 Hacked by Barry Warsaw (barry@zpt._zope.com)
