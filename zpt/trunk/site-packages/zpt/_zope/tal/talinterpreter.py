...
$Id: talinterpreter.py 38014 2005-08-19 23:01:37Z fdrake $
"""
import cgi
import operator
import sys
...
from zpt._zope.i18nmessageid import MessageID, Message
from zpt._zope.tal.taldefs import quote, TAL_VERSION, METALError
from zpt._zope.tal.taldefs import isCurrentVersion
from zpt._zope.tal.taldefs import getProgramVersion, getProgramMode
from zpt._zope.tal.talgenerator import TALGenerator
from zpt._zope.tal.translationcontext import TranslationContext
...
class TALInterpreter(object):
    ...
    def insertHTMLStructure(self, text, repldict):
        from zpt._zope.tal.htmltalparser import HTMLTALParser
    ...
    def insertXMLStructure(self, text, repldict):
        from zpt._zope.tal.talparser import TALParser
        gen = AltTALGenerator(repldict, self.engine, 0)
        p = TALParser(gen)
        gen.enable(0)
