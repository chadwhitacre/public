...
import zpt._zope.tal.driver
import zpt._zope.tal.tests.utils
...
def main():
    ...
    if not args:
        ...
        if zpt._zope.tal.tests.utils.skipxml:
            xmlargs = []
        else:
    ...
    for arg in args:
        ...
        if not unittesting:
            print arg,
            sys.stdout.flush()
        if zpt._zope.tal.tests.utils.skipxml and arg.endswith(".xml"):
