...
#from zpt._zope.documenttemplate.dt_html import HTMLFile
...
def time_zpt(fn, count):
    from zpt._zope.pagetemplate.pagetemplate import PageTemplate
    pt = PageTemplate()
...
if __name__ == "__main__":
    ...
    if runtests:
        ...
        rc = os.spawnl(os.P_WAIT, sys.executable,
                       sys.executable, "test.py", "zpt._zope.tal.tests")
        if rc > 0:
