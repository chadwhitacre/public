...
$Id: test_htmltalparser.py 38014 2005-08-19 23:01:37Z fdrake $
"""
import pprint
import sys
import unittest

from zpt._zope.tal import htmltalparser, taldefs
...
class TALGeneratorTestCases(TestCaseBase):
    ...
    def test_attributes_1(self):
        self._run_check("<a href='foo' name='bar' tal:attributes="
                        "'href string:http://www.zpt._zope.org; x string:y'>"
                        "link</a>", [
            ('setPosition', (1, 0)),
            ('beginScope',
             {'tal:attributes': 'href string:http://www.zpt._zope.org; x string:y',
              'name': 'bar', 'href': 'foo'}),
            ('startTag', ('a',
             [('href', 'foo', 'replace', '$string:http://www.zpt._zope.org$', 0, None),
              ('name', 'name="bar"'),
              ('tal:attributes',
               'href string:http://www.zpt._zope.org; x string:y', 'tal'),
