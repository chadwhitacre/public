...
from zpt._zope.schema import Field, Text, Int
from zpt._zope.schema.interfaces import ValidationError, RequiredMissing
...
def test_suite():
    return TestSuite((
        ...
        DocTestSuite("zpt._zope.schema._field"),
        DocTestSuite("zpt._zope.schema._bootstrapfields"),
        ))
