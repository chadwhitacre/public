...
from zpt._zope.schema import Text, accessors
from zpt._zope.schema.interfaces import IText
from zpt._zope.schema.accessors import FieldReadAccessor, FieldWriteAccessor
from zpt._zope.interface.verify import verifyClass, verifyObject
from zpt._zope.interface import document
