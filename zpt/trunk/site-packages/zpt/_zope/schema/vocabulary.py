...
"""
from zpt._zope.interface.declarations import directlyProvides, implements
from zpt._zope.schema.interfaces import ValidationError
from zpt._zope.schema.interfaces import IVocabularyRegistry
from zpt._zope.schema.interfaces import IVocabulary, IVocabularyTokenized
from zpt._zope.schema.interfaces import ITokenizedTerm, ITitledTokenizedTerm
...
class SimpleVocabulary(object):
    ...
    def __contains__(self, value):
        """See zpt._zope.schema.interfaces.IBaseVocabulary"""
        try:
    ...
    def getTermByToken(self, token):
        """See zpt._zope.schema.interfaces.IVocabularyTokenized"""
        try:
    ...
    def __iter__(self):
        """See zpt._zope.schema.interfaces.IIterableVocabulary"""
...
class VocabularyRegistry(object):
    ...
    def get(self, object, name):
        """See zpt._zope.schema.interfaces.IVocabularyRegistry""" 
        try:
...
try:
    from zpt._zope.testing.cleanup import addCleanUp
except ImportError:
