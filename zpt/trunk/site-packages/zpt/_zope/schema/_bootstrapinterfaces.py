...
$Id: _bootstrapinterfaces.py 25177 2004-06-02 13:17:31Z jim $
"""
...
class ValidationError(zpt._zope.interface.Invalid):
...
class IFromUnicode(zpt._zope.interface.Interface):
