...
$Id: interfaces.py 37565 2005-07-29 20:46:23Z srichter $
"""

from zpt._zope.interface import Interface, Attribute
from zpt._zope.schema._bootstrapfields import Field, Text, TextLine, Bool, Int
from zpt._zope.schema._bootstrapfields import Container, Iterable

from zpt._zope.i18nmessageid import MessageIDFactory
_ = MessageIDFactory("zpt._zope")

# Import from _bootstrapinterfaces only because other packages will expect
# to find these interfaces here.
from zpt._zope.schema._bootstrapinterfaces import StopValidation, ValidationError
from zpt._zope.schema._bootstrapinterfaces import IFromUnicode
from zpt._zope.schema._bootstrapinterfaces import RequiredMissing, WrongType
from zpt._zope.schema._bootstrapinterfaces import ConstraintNotSatisfied
from zpt._zope.schema._bootstrapinterfaces import NotAContainer, NotAnIterator
from zpt._zope.schema._bootstrapinterfaces import TooSmall, TooBig
from zpt._zope.schema._bootstrapinterfaces import TooShort, TooLong
from zpt._zope.schema._bootstrapinterfaces import InvalidValue
