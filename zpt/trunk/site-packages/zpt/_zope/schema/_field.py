...
$Id: _field.py 37565 2005-07-29 20:46:23Z srichter $
"""
...
from zpt._zope.interface import classImplements, implements, directlyProvides
from zpt._zope.interface.interfaces import IInterface, IMethod

from zpt._zope.schema.interfaces import IField
from zpt._zope.schema.interfaces import IMinMaxLen, IText, ITextLine
from zpt._zope.schema.interfaces import ISourceText
from zpt._zope.schema.interfaces import IInterfaceField
from zpt._zope.schema.interfaces import IBytes, IASCII, IBytesLine, IASCIILine
from zpt._zope.schema.interfaces import IBool, IInt, IFloat, IDatetime
from zpt._zope.schema.interfaces import IChoice, ITuple, IList, ISet, IDict
from zpt._zope.schema.interfaces import IPassword, IObject, IDate, ITimedelta
from zpt._zope.schema.interfaces import IURI, IId, IFromUnicode
from zpt._zope.schema.interfaces import ISource, IBaseVocabulary

from zpt._zope.schema.interfaces import ValidationError, InvalidValue
from zpt._zope.schema.interfaces import WrongType, WrongContainedType, NotUnique
from zpt._zope.schema.interfaces import SchemaNotProvided, SchemaNotFullyImplemented
from zpt._zope.schema.interfaces import InvalidURI, InvalidId, InvalidDottedName
from zpt._zope.schema.interfaces import ConstraintNotSatisfied
from zpt._zope.schema.interfaces import Unbound

from zpt._zope.schema._bootstrapfields import Field, Container, Iterable, Orderable
from zpt._zope.schema._bootstrapfields import MinMaxLen
from zpt._zope.schema._bootstrapfields import Text, TextLine, Bool, Int, Password
from zpt._zope.schema._bootstrapfields import MinMaxLen, ValidatedProperty
from zpt._zope.schema.fieldproperty import FieldProperty
from zpt._zope.schema.vocabulary import getVocabularyRegistry
from zpt._zope.schema.vocabulary import SimpleTerm, SimpleVocabulary
...
class Choice(Field):
    ...
    def bind(self, object):
        """See zpt._zope.schema._bootstrapinterfaces.IField."""
...
class Id(BytesLine):
    ...
    def _validate(self, value):
        ...
        >>> id.validate("zpt._zope.app.content")
        >>> id.validate("zpt._zope.app.content/a")
        Traceback (most recent call last):
        ...
        InvalidId: zpt._zope.app.content/a
        >>> id.validate("http://zpt._zope.app.content x y")
        Traceback (most recent call last):
        ...
        InvalidId: http://zpt._zope.app.content x y
        """
