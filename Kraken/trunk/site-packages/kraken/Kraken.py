    ...
    def devour(self):
        ...
        if len(msg_nums) == 0:
            ...
            for num in msg_nums:
                ...
                if self.from_addr(M,num).lower() not in self.whale.accept_from:
                    ...
                    # tweak the headers
                    try:
                        msg.replace_header('Reply-To', imap['username'])
                    except KeyError:
                        msg.__setitem__('Reply-To', imap['username'])
