class testdata:
    ...
    COMPATIBLE_REQUEST = {'HTTP_USER_AGENT':'gecko/20050414'}
    COMPATIBLE_USERAGENT = 'Gecko/20030313'
    ...
    INCOMPATIBLE_REQUEST = {'HTTP_USER_AGENT':'Mozilla/4.08'}
    INCOMPATIBLE_USERAGENT = 'Gecko/20020513'
...
</div>""" # cause I trim trailing spaces in my editor
