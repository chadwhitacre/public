...
class Website:
    ...
    def __respond_unsafely(self, request):
        ...
        fspath = self.__static.find_default(fspath)
        ...
        context['__file__'] = fspath                # ephemeral
    ...
    def __load_rulesets(self):
        ...
        for line in fp:
            ...
            if not line:                            # blank line
                ...
                if msg:
                    raise HandlersConfError(msg, lineno)
                ruleset = HandlerRuleSet(rulefuncs, obj.handle)
    ...
    def __get_handler(self, fspath):
        ...
        if handler is None:
            ...
            raise HandlerError("No handler found.") # don't expose fs info
        return handler
