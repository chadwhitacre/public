...
class CitConn:
    ...
    def ENT0(self, post=1, to=u'', anon=0, format=0, subject=u'', name=u'',
        ...
        Takes arguments as described in the protocol. Returns an email address,
        None, or a confirmation tuple.
    ...
    def MSG0(self, msgid, gimme=0):
        ...
        """
        c, v = self._req(u"MSG0 %d|%d" % (msgid, gimme))
        assert c == 100
