...
\lineiii{520}{ERROR + NOT_LOGGED_IN}
    {Not logged in.}

\lineiii{550}{ERROR + HIGHER_ACCESS_REQUIRED}
    {Higher access is required.  An explanation follows, worded in a form that
    can be displayed to the user.}

\lineiii{570}{ERROR + NO_SUCH_USER}
...
criteria, and then read the message list.
 ...
 \strong{Example 1:} Read all new messages
...
\end{verbatim}
 ...
 \strong{Example 2:} Read the last five messages
...
\end{verbatim}
 ...
 \strong{Example 3:} Read all messages written by "IGnatius T Foobar"
...
\lineii{0}{Headers and body}

\lineii{1}{Headers only}

\lineii{2}{Body only}

\lineii{3}{Headers only, with MIME information suppressed (this runs faster)}
