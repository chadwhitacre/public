...
// basepath example for Zope Plone
...
// toolbars for plone
// use SmallZopeCmf for small textarea form input (as "description")
...
FCKConfig.ToolbarSets["ZopeCmf"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','Table','Rule','SpecialChar','Smiley','UniversalKey'],
	['Form','Checkbox','Radio','TextField','Textarea','Select','Button','ImageButton','HiddenField'],
	'/',
	['Style','FontFormat','FontName','FontSize'],
	['TextColor','BGColor'],
...
// Font Combos
FCKConfig.FontNames		= 'Arial, Geneva, Helvetica, Helv, sans-serif;Verdana, Arial, Helvetica, sans-serif;Tahoma, Arial, Helvetica, sans-serif;Comic Sans MS, Arial, Helvetica, sans-serif;Garamond, Times New Roman, Times, Serif;Times New Roman, Times, Roman, Serif;Courier New, Courier;Letter Gothic, LetterGothic, Courier New, Courier;Lucida Console, Courier New, Courier' ;
...
//FCKConfig.ImageBrowserURL = FCKConfig.BasePath + "filemanager/browser/default/browser?Type=Image&Connector=connectors/zope/zptConnector" ;
