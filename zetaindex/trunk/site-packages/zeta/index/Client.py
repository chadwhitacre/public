...
class Client:
    """Represent a connection to a zetaindex server.

    Our job here is to adapt the zetaindex protocol to Python's data types.
    ...
    def __init__(self, host='localhost', port=53700, _listen=False):
