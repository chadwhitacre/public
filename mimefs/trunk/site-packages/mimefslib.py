...
mimefs 0 is defined as an XMLRPC API with the following callables.
...
__all__ = ['FileSystem', 'Message', 'Server', 'Volume']
...
class Volume:
    ...
    def exists(self, mid=''):
        return self._fs.exists(self._vid, mid)

    def list(self, mid=''):
        return self._fs.list(self._vid, mid)

    def open(self, mid=''):
        return self._fs.open(self._vid, mid)

    def remove(self, mid=''):
        return self._fs.remove(self._vid, mid)
