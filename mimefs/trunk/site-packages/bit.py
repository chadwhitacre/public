"""This module defines functinos for working with bit buckets.
"""
...
def Map(n, keys=(), size=None, bucket=False):
...
class Bucket:
    ...
    def __init__(self, n, names):
        """Takes a decimal number and a list of names for each bit.

        The names should be given in left-to-right bit-string order.
