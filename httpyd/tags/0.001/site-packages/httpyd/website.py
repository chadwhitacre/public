...
class Plugins:
    ...
    def __init__(self, __):
        """Takes the path of the magic directory.
        """

        if __ is not None:

            # The first plugin is always the base system.
            # ===========================================

            setattr(self, 'base', Plugin(__))


            # Then we look for plugins proper.
            # ================================

            local = (__ is not None) and join(__, 'local') or None
            if (local is not None) and isdir(local):
...
class Website:
    ...
    directories under __/local. Each script is run with 'website' and 'plugin' in
    ...
    def __init__(self, paths):
        ...
        """
        self.paths = paths
        self.plugins = Plugins(self.paths.__)
    ...
    def __load_hooks(self):
        """Return a maplocalg of hook names to lists of code objects.
        """
        ...
        # Search all directories under __/etc/local.
        # ========================================
