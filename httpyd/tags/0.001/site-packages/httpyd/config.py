...
class Configuration:
    """Represent the configuration of an httpyd server from three sources:
    ...
    def __init__(self, argv):
        ...
        parser_.add_option("-d", "--daemon", dest="daemon",
        ...
        if not os.path.isdir(paths.__):
            ...
            paths.lib = os.path.join(paths.__, 'lib')
            if not os.path.isdir(paths.lib):
                paths.lib = None
            else:
                sys.path.insert(0, paths.lib)
        self.paths = paths
